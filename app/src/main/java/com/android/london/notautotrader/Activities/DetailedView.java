...
public class DetailedView extends AppCompatActivity /*implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Listing myListing = new Gson().fromJson(jsonMyObject, Listing.class);
